...
<br><div id="mainMenuContent">Dashboard > Inventory Management > Stock Withdrawal</div></div><div> <div id="content">
...
<!--content here-->
                        ...
                        <?php
                                ...
                                while($row = mysql_fetch_array($result))
                                        {
                            echo "<form method=\"post\" action=\"stockout_process.php\">";
                            ...
                            echo "<p><label>Withdraw Inventory Item </label><input  type=\"text\" name=\"outItem\"></p><br>";
			    echo "<p><label>Remarks </label><textarea name=\"remarks\"></textarea></p><br>";
